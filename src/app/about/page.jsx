...
const AboutPage = () => {
  ...
  const handleJobDescriptionClick = (jobDescription) => {
    setSelectedJobDescription(jobDescription);
    setShowPopup(true);
  };

  const jobDescription1 = "Developed RESTful APIs enabling customer registrations for enterprise product, to perform CRUD operations using NodeJs and Sequelize. An in-house web application that collection of data from an ESP32 chip and its processing using NodeJs, PostgreSQL(RDBMS to store customer data), Sequelize for database operations, and JWT for authentication.";

  const jobDescription = "Designed Reviews page for the website, where different Organisations(charity) People can ’Manage Reviews’ page. Implemented different functionalities like only a valid charity editor and project reporter can add attendance in events, and Crafted the ’Manage Events’ page. Project Management with Jira Software and Confluence.Also used PostgreSQL as Database.";

  // Function to truncate the description to the first 9 words
  const truncateDescription = (description) => {
    const wordsArray = description.split(' ');
    return wordsArray.slice(0, WORDS_LIMIT).join(' ');
  };

  // Truncate the job description to the first 9 words
  const truncatedDescription = truncateDescription(jobDescription);

  const truncatedDescription1 = truncateDescription(jobDescription1);
      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
            I am Kavish Surana,  a fourth-year undergraduate student majoring in
            Electronics and Computer Science Engineering at KIIT Bhubaneswar.
            I am ambitious and want to work where I will be continually challenged 
            and pushed in my role. It’s essential for me to grow and develop personally 
            and professionally and this is a place I will be surrounded by like-minded people. 
            The principles will ensure I always work to high standards and will continue to 
            build up an impressive set of skills and qualities.
            </p>
            {/* BIOGRAPHY QUOTE */}
            ...
            >
              ...
              <div className="flex justify-between h-96">
                ...
                <div className="w-1/3 ">
                  ...
                  <div className="container">
                    {/* Render the truncated job description */}
                    <div className="p-3 text-sm italic" onClick={() => handleJobDescriptionClick(jobDescription)}>
                      {truncatedDescription}
                    </div>
                    <span className="text-sm flex items-center justify-center" onClick={() => handleJobDescriptionClick(jobDescription)}>Click for more...</span>

                    {/* Check if showPopup is true, then render the Popup component */}
                    {showPopup && (
                      <Popup jobDescription={selectedJobDescription} onClose={() => setShowPopup(false)} />
                    )}
                  </div>
                  {/* JOB DATE */}
              ...
              <div className="flex justify-between h-96">
                ...
                <div className="w-1/3 ">
                  ...
                  <div className="container">
                    {/* Render the truncated job description */}
                    <div className="p-3 text-sm italic" onClick={() => handleJobDescriptionClick(jobDescription1)}>
                      {truncatedDescription1}
                    </div>
                    <span className="text-sm flex items-center justify-center" onClick={() => handleJobDescriptionClick(jobDescription1)}>Click for more...</span>
